...
Person.Age - Integer Person.Gender - String (Categorical)\\

Person.Race - String (Categorical)\\

Incident.Date.Month - Integer Incident.Date.Day - Integer (Quantitative)\\

Incident.Date.Year - Integer (Quantitative)\\

Incident.Date.Full - String (Categorical)\\

Incident.Location.City - String Incident.Location.State - String (Categorical)\\
