...
Our research topic examines police shooting history on the basis of race, gender, and age. We expect that male individuals of minority communities with previous histories of mental illnesses are most likely to consist of the largest victim population.
...
As seen in Figure 6, the race with the most unarmed victims was black and the race with the least unarmed victims was Native American. This visualization can provide ample information on implicit bias and how race impacts policemen's approaches to interactions with different races.
